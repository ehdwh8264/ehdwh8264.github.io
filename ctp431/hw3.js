...
var synth_params = {
	lfoRate:10,
	lfoDepth: 2.1,
	filterCutoffFreq:4500,
	filterQ:1,
	filterEnvAttackTime: 0.1,
	filterEnvDecayTime: 0.2,
	filterEnvSustainLevel: 0.8,
	filterEnvReleaseTime: 2.5,
	ampEnvAttackTime: 0.47,
	ampEnvDecayTime: 0.2,
	ampEnvSustainLevel: 0.85,
	ampEnvReleaseTime: 1.7
};

var delay_params = {
	delayTime: 0.3,
	delayFeedbackGain: 0.65,
	delayWetDry: 0.48
};
var reverb_params = {
	reverbWetDry: 0.8
...
nx.onload = function() {
	...
	gui_filter_env_attack.on('*',function(data){
		synth.updateParams('env_attack', data.value);
	});
	...
	gui_filter_env_decay.on('*',function(data){
		synth.updateParams('env_decay', data.value);
	});
	...
	gui_filter_env_sustain.on('*',function(data){
		synth.updateParams('env_sustain', data.value);
	});
	...
	gui_filter_env_release.on('*',function(data){
		synth.updateParams('env_release', data.value);
	});
